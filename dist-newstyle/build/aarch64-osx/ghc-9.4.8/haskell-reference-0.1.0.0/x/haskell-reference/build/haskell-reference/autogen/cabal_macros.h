...
/* package haskell-reference-0.1.0.0 */
#ifndef VERSION_haskell_reference
#define VERSION_haskell_reference "0.1.0.0"
#endif /* VERSION_haskell_reference */
#ifndef MIN_VERSION_haskell_reference
#define MIN_VERSION_haskell_reference(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_reference */
...
#define CURRENT_COMPONENT_ID "haskell-reference-0.1.0.0-inplace-haskell-reference"
